...
var apiFetch = async (action, body) => {
  const init = body !== void 0 ? { method: "POST", headers: { "content-type": "application/json" }, body: JSON.stringify(body) } : void 0;
...
function SettingsPage() {
  ...
  const save = () => {
    setMsg("");
    apiFetch("config-set", { config: cfg }).then((v) => {
